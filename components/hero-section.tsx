      ...
      <div className="mx-auto max-w-7xl">
        <div className="section-panel relative overflow-hidden px-6 py-6 sm:px-8 lg:min-h-[22rem] lg:px-12 lg:py-8">
          ...
          <Image
            ...
            width={607}
            height={745}
            className="pointer-events-none absolute bottom-0 left-2 z-0 h-auto w-20 select-none opacity-75 sm:left-4 sm:w-28 sm:opacity-85 lg:left-6 lg:w-44 xl:w-48"
            priority
          />

          <div className="relative z-10 pb-20 sm:pb-16 lg:pl-40 lg:pb-0 xl:pl-44">
            ...
            <h1 className="mt-4 max-w-4xl animate-reveal font-display text-4xl font-semibold leading-[0.96] tracking-[-0.03em] text-ink sm:text-5xl lg:text-6xl xl:text-[4.5rem]">
              {siteMeta.fullName}
            </h1>
            <p className="mt-3 max-w-3xl animate-reveal text-base font-semibold text-ink/76 sm:text-lg lg:text-[1.1rem]">
              {siteMeta.role}
            </p>
            <p className="mt-4 max-w-3xl animate-reveal text-sm leading-6 text-ink/72 sm:text-base sm:leading-7">
              {siteMeta.intro}
            </p>
