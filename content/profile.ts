...
export const aboutParagraphs = [
  "Senior Software Quality Assurance Engineer with 15+ years of experience in test management, test automation, and process optimization.",
  "I have led global testing initiatives, implemented automation frameworks, coordinated FAT and SAT activities, and supported enterprise releases across large operational systems.",
  "My working style blends QA leadership with practical execution: build the strategy, make the tooling useful, support the team, and keep delivery stable."
];
