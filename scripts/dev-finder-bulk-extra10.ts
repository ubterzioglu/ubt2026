// Geçici devam script'i — ek 10 Almanya şehri (11-20. en kalabalık) x 4 kategori
// için service-finder işlerini sırayla oluşturur ve çalıştırır. Kullanım sonrası silinir.
